  ...
  registerTool(
    server,
    {
      ...
      inputSchema: {
        ...
        private_key: z.string().optional().describe("PEM-encoded private key"),
        certificate_path: z
          .string()
          .optional()
        ...
        port_dns_over_tls: z.number().optional().describe("DNS-over-TLS port"),
        port_dns_over_quic: z
          .number()
          .optional()
          .describe("DNS-over-QUIC port"),
        force_https: z.boolean().optional().describe("Force HTTPS redirect"),
      },
      handler: async (args) => {
        const data = (await client.post("tls/validate", args)) as TlsValidation;
